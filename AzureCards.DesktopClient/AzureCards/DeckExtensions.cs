...
namespace AzureCards.DesktopClient
{
    public static partial class DeckExtensions
    {
        ...
        /// Reference to the AzureCards.DesktopClient.IDeck.
        /// </param>
        /// <param name='deckId'>
        /// Required.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<AzureCards.DesktopClient.Models.DealResponseMessage> result = await operations.DealWithOperationResponseAsync(deckId, cardCount, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
